...
from mi_odometria_interfaces.action import Poligono

import math

class Poligono_ActionServer(Node):
    ...
    def __init__(self,
        ...
        # Crea el nodo
        super().__init__('poligono_actionServer')
        ...
        self.action_server = ActionServer(self, Poligono, 'poligono', self.action_callback, callback_group=self.reentrant_group)
    ...
    def action_callback(self, action_handle):
        ...
        # Calcula el ángulo de giro en cada vértice del polígono
        ...
        for mov in range(num_lados*2):
            ...
            # Movimiento impar: rotación
                ...
                self.mov_rotacion(action_handle, angulo_giro)
...
def main(args=None):
    ...
    # Crea el nodo
    poligono_actionServer = Poligono_ActionServer()
    # Crea el executor multihilo y le añade el nodo
    executor = MultiThreadedExecutor(num_threads=2)
    executor.add_node(poligono_actionServer)
    # Inicia el executor
    executor.spin()
    # Destruye el nodo
    poligono_actionServer.destroy_node()
